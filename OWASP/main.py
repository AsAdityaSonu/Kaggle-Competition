...
# Load training data
trainData = pd.read_csv("/Users/adityapandey/PycharmProjects/Kaggle-Competition /OWASP/train.csv")
...
# Load test data
testData = pd.read_csv("/Users/adityapandey/PycharmProjects/Kaggle-Competition /OWASP/test.csv")
